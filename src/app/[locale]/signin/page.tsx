      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Sign in to your CookAssistant account
          </p>
        </div>
          ...
          {(error || oauthError) && (
            <div className="mb-6 rounded-xl bg-red-50 dark:bg-red-900/20 p-4 border border-red-200 dark:border-red-800">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm font-medium text-red-700 dark:text-red-400">{error || oauthError}</p>
              </div>
            </div>
          )}
          ...
          {hasSocial && (
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-white dark:bg-zinc-900 px-3 text-muted-foreground">or sign in with email</span>
              </div>
            </div>
          )}
